  ...
  const foundations = [
    {
      ...
      logo: "https://images.unsplash.com/photo-1559589689-577aabd1db4f?q=80&w=2070",
      link: "#",
    },
    {
      name: "Bill & Melinda Gates Foundation",
      description: "Partnering on health, education, and development initiatives.",
      logo: "https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?q=80&w=2070",
      link: "#",
    },
    {
      name: "Open Society Foundations",
      description: "Supporting democratic governance and human rights initiatives.",
      logo: "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?q=80&w=2070",
      link: "#",
    },
    {
      name: "Ford Foundation",
      description: "Collaborating on social justice and equality programs.",
      logo: "https://images.unsplash.com/photo-1507608616759-54f48f0af0ee?q=80&w=2071",
      link: "#",
    },
  ]
            ...
            >
              <Card className="group overflow-hidden hover:shadow-lg transition-all duration-300 h-full border border-orange-200 dark:border-orange-800">
                <div className="flex flex-col md:flex-row">
                  <div className="p-6 flex items-center justify-center bg-orange-50 dark:bg-orange-950/30 group-hover:bg-orange-100 dark:group-hover:bg-orange-900/40 transition-colors duration-300 md:w-1/3 relative overflow-hidden">
                    <Image
