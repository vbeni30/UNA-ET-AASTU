...
export function StudentOrganizationsContent() {
  ...
  const studentOrganizations = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1603126857599-f6e157fa2fe6?q=80&w=2070",
      link: "#",
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 flex items-center gap-2">
                    <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center">{org.icon}</div>
                  </div>
                </div>
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold mb-2">{org.name}</h3>
                  <p className="text-gray-500 dark:text-gray-400 mb-6">{org.description}</p>
                  <Button variant="outline" size="sm" asChild className={`mt-auto group/btn ${org.borderColor}`}>
                    <Link href={org.link}>
