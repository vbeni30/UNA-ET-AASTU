  ...
  const governmentBodies = [
    {
      ...
      logo: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=2070",
      link: "#",
    ...
    },
    {
      ...
      logo: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?q=80&w=2070",
      link: "#",
    ...
    },
    {
      ...
      logo: "https://images.unsplash.com/photo-1526470608268-f674ce90ebd4?q=80&w=2074",
      link: "#",
    ...
    },
    {
      ...
      logo: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?q=80&w=2074",
      link: "#",
            ...
            >
              <Card className="group overflow-hidden hover:shadow-lg transition-all duration-300 h-full border border-purple-200 dark:border-purple-800">
                <div className="flex flex-col md:flex-row">
                  <div className="p-6 flex items-center justify-center bg-purple-50 dark:bg-purple-950/30 group-hover:bg-purple-100 dark:group-hover:bg-purple-900/40 transition-colors duration-300 md:w-1/3 relative overflow-hidden">
                    <Image
