  ...
  const navLinks = [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { name: "Embassies", href: "/partnerships/embassies" },
        { name: "Government Bodies", href: "/partnerships/government" },
        { name: "Foundations", href: "/partnerships/foundations" },
        { name: "UN Agencies", href: "/partnerships/un-agencies" },
